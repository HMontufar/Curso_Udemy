...
aplicacion.geometry('1060x620+0+0')
...
# Panel bebidas
panel_bebidas = LabelFrame(panel_izquierdo, text='Babidas', font=('Dosis', 19, 'bold'), bd=1, relief=FLAT, fg='azure4')
...
lista_bebidas = ['agua', 'soda', 'jugo', 'cafe', 'vino1', 'vino2', 'cerveza1', 'cerveza2']
...
botones_calculadora = ['7', '8', '9', '+', '4', '5', '6', '-', '1', '2', '3', 'X', 'R', 'C', '0', '/']
botones_guardados = []
